...
class MonarqSim(BaseDevice):
    ...
    def name(self):
        try:
            ...
            logger.error("Error %s in name located in MonarqSim: %s", type(e).__name__, e)
            return None
    ...
    def __init__(self, wires = None, shots = None, client = None, processing_config = None):
        try:
            ...
            logger.error("Error %s in __init__ located in MonarqSim: %s", type(e).__name__, e)
    ...
    def _measure(self, tape : QuantumTape):
        ...
        try:
            ...
            logger.error("Error %s in _measure located in MonarqSim: %s", type(e).__name__, e)
            return None
    ...
    def machine_name(self):
        try:
            ...
            logger.error("Error %s in machine_name located in MonarqSim: %s", type(e).__name__, e)
            return None