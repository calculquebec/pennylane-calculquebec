...
class PostProcessor:
    ...
    def get_processor(behaviour_config : ProcessingConfig, circuit_wires):
        ...
        def process(tape : QuantumTape, results : dict[str, int]):
            ...
            try:
                ...
                logger.error("Error %s in get_processor.process located in PostProcessor: %s", type(e).__name__, e)
                return results
    ...
    def expand_full_measurements(tape, wires):
        ...
        try:
            ...
            logger.error("Error %s in expand_full_measurements located in PostProcessor: %s", type(e).__name__, e)
            return tape
