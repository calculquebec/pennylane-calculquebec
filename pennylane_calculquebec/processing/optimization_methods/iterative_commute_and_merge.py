...
def remove_root_zs(tape : QuantumTape, iterations = 3) -> QuantumTape:
    ...
    try:
        ...
        logger.error("Error %s in remove_root_zs located in iterative_commute_and_merge: %s", type(e).__name__, e)
        return tape
...
def remove_leaf_zs(tape : QuantumTape, iterations = 3) -> QuantumTape:
    ...
    try:
        ...
        logger.error("Error %s in remove_leaf_zs located in iterative_commute_and_merge: %s", type(e).__name__, e)
        return tape
...
def _remove_trivials(tape : QuantumTape, iteration = 3, epsilon = 1E-8) -> QuantumTape:
    ...
    try:
        ...
        logger.error("Error %s in _remove_trivials located in iterative_commute_and_merge: %s", type(e).__name__, e)
        return tape
...
def commute_and_merge(tape : QuantumTape) -> QuantumTape:
    ...
    try:
        ...
        logger.error("Error %s in commute_and_merge located in iterative_commute_and_merge: %s", type(e).__name__, e)
