...
def test_place_no_4(mock_machine_graph):
...
def test_place_too_many_wires( mock_machine_graph):
...
def test_place_too_many_wires_holed_machine(mock_machine_graph):
